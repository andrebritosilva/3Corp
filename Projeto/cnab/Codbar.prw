...
±±ºPrograma  ³CODBAR    ºAutor  ³Anderson Rodrigues  º Data ³  12/06/05   º±±
...
///--------------------------------------------------------------------------\
//| Função: CODBAR				Autor: Anderson Rodrigues    Data: 10/03/15  |
//|--------------------------------------------------------------------------|
...
Local i
SETPRVT("cStr,lRet,cTipo,nConta,nMult,nVal,nDV,cCampo,nMod,nDVCalc")
